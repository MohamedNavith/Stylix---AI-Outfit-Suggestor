      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        <div>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', marginTop: '2px' }}>
            Catalog clothing photos & 360° videos on a hanger to auto-tag via AI Vision
          </p>
        </div>
      </div>
            ...
            <div style={{
              ...
              {uploading ? (
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' }}>
                  ...
                  <span style={{ fontSize: '0.85rem', fontWeight: 600, color: 'var(--accent)' }}>Scanning via AI Vision...</span>
                </div>
              ) : (
                <label style={{ cursor: 'pointer', display: 'block' }}>
                  ...
                  <p style={{ fontSize: '0.7rem', color: 'var(--text-muted)', marginTop: '4px' }}>
                    AI Vision automatically classifies fabric, tags and formality profile
                  </p>
                </label>
              )}
            </div>
              ...
              {uploading ? (
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', fontSize: '0.8rem', color: 'var(--text-primary)' }}>
                    ...
                    <span style={{ fontWeight: videoStep === 2 ? '700' : '400', color: videoStep === 2 ? 'var(--accent)' : 'var(--text-muted)' }}>[2/4] AI Vision Scanning...</span>
